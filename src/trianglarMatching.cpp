...
void
TriangleMatching::constructTriangles(const Cloud3D::ConstPtr& stem_positions,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
TriangleMatching::satisfyLocalConsistency(const Point3D& feature_src,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
TriangleMatching::satisfyGlobalConsistency(const std::vector<int>& pair_initial,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
TriangleMatching::localMatching() {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
TriangleMatching::globalMatching() {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
TriangleMatching::randomGlobalMatching() {
//	const auto& num_pairs = locally_matched_pairs_.size();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
TriangleMatching::estimateTransformation(Eigen::Matrix4f& transform) {

    constructTriangles(stem_positions_src_, triangles_src_);
    cout << "[ Debug ] src cloud size ... " << stem_positions_src_->points.size() << endl;
    cout << "[ Debug ] src triangle size ... " << triangles_src_.size() << endl;

    constructTriangles(stem_positions_tgt_, triangles_tgt_);
    cout << "[ Debug ] tgt cloud size ... " << stem_positions_tgt_->points.size() << endl;
    cout << "[ Debug ] tgt triangle size ... " << triangles_tgt_.size() << endl;
    ...
    cout << "[ Debug ] stem_matches_ size ... " << count_matches << endl;
